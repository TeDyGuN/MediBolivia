...
class TransporteController extends Controller{
  ...
  public function getTransporte($year){
    $trans = Transporte::where('year', $year)
            ->get();
  	return view('Sistema/Transporte', compact('trans', 'year'));
  }
  public function saveTransporte(Request $request){
    $cor = new Transporte();
    $cor->tipo = $request->tipo;
    $cor->nombre = $request->nombre;
    $cor->salida = $request->salida;
    $cor->llegada = $request->llegada;
