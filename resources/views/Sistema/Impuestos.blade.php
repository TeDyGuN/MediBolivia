...
@section('content')
    ...
    <div class="container">
          ...
          <div class="col-md-12">
              <div class="panel panel-default" id="panel-profin">
                  ...
                  <div class="panel-body">
                        ...
                        @endif
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/impuesto/save') }}">
                                {{ csrf_field() }}
                        ...
                        @if ($success)
                            <div class="alert alert-success">
                                <strong>!!Felicidades!!</strong>Se Creo el Impuesto Correctamente <br><br>
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default" id="panel-profin">
                <div class="panel-heading text-center textoHeader">Detalle Impuestos</div>
                <div class="panel-body">
